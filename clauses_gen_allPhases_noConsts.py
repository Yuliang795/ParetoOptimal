...
while loandra_status=='OPTIMUM FOUND':
    ...
    if obj_ == 'b0':    
        ...
        if iter_ind!=0:
            ...
            write_pairs_to_file(Distance_Class[:curr_b1_sat+1], filename=b0b1_MlCl_Consts_path, type="ml")
    ...
    if obj_ == 'b1':
        ...
        write_pairs_to_file(Distance_Class[curr_b0_sat:], filename=b0b1_MlCl_Consts_path, type="cl")
        # pass
    ...
    TC.counter(clausesIO_time_counter_start,
    ...
    if not (iter_ind == 0 and obj_=="b0"):
        paramConsts = f'-DconstsPath={b0b1_MlCl_Consts_path}'
    ...
    stage2_Total_time_counter_end = time.perf_counter()
    TC.counter(stage2_Total_time_counter_start,
            stage2_Total_time_counter_end,
            'Total',
            np.nan)
    # print stat
    TC.print_dict()

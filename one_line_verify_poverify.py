...
if not os.path.exists(out_folder):
    os.mkdir(out_folder)
out_file_name=f'{input_out_file_name}_po_verify_'+current_time
# out_file_handle = open(out_folder+out_file_name,'w')


verify_df_columns = ['data','seed','e','kappa','cl_ml_ratio',
                     'p2_lm_b0', 'p2_lm_b1','p2_lm_loandra_status','p2_lm_solver_time',
                     'p2_lp_b0', 'p2_lp_b1', 'p2_lp_loandra_status','p2_lp_solver_time']
        ...
        for folder in folders:
            ...
            for filename in os.listdir(folder_path):
                if re.match(file_name_pattern_b0, filename):
                    ...
                    # print('\n\n\n')
                    # print(one_line_res_lm)
                    # print(one_line_res_lp)
